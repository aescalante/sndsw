...
enum DetectorId {kEmulsionDet, kLHCScifi, kMuFilter, kMagnet, kVETO, kTimeDet, ktauRpc, ktauHpt, ktauTT, ktauTarget, kStraw, kecal, khcal, kMuon , kPreshower, kTRSTATION, kSplitCal, kBox1, kSpectrometer	\
